<tr {{ $user->is_banned ? "style=background-color:var(--bs-red);" : '' }}>
    ...
    <td style="padding: 0; width: 20%;" class="text-center">
        ...
        <button type="button" class="user-action user-ban btn btn-warning text-white me-2 my-2 has-tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ban user"><i class="fas fa-ban"></i></button>
