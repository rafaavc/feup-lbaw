...
<div>
    ...
    <div class="form-floating mb-4 has-tooltip" title="Enter a nice step description">
        ...
        @else
            <textarea minlength="10" maxlength="512" name="steps[{{ $index - 1 }}][description]" class="form-control" placeholder="Your awesome description here..." id="floatingTextarea2" style="height: 5rem">{{ isset($step->description) ? $step->description : "" }}</textarea>
        @endif
