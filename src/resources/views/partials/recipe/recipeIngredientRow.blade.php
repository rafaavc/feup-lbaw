<div class="row g-3 mb-3">
        ...
        <div class="row g-3">
            <div class="col-sm">
                <div class="form-floating">
                    <input type="number" class="form-control" placeholder="0" aria-label="Quantity" id="quantityInput" <?=isset($ingredient->pivot->$quantity) ? 'value="{{ $ingredient->pivot->$quantity }}"' : ""?>>
    ...
    <div class="col-lg">
        <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" placeholder="Tomato" <?=isset($ingredient->name) ? 'value="{{ $ingredient->pivot->id_unit }}"' : ""?>>
