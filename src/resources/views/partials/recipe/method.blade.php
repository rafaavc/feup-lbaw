<section id="method" class="mt-5">
    ...
    @foreach ($steps as $idx => $step)
        <section class="instruction d-inline-block col-12 mt-4">
            <h3 class="btn p-0 has-tooltip" data-bs-toggle="collapse" href="#instruction{{ $idx+1 }}" role="button" aria-expanded="false" aria-controls="instruction{{ $idx+1 }}" title="Click to hide or show this step">
