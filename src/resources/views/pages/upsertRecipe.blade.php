            ...
            <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-lg">
                                <div class="form-floating has-tooltip" title="Give your recipe a nice name">
                            ...
                            <div class="col-md">
                                <div class="form-floating has-tooltip" title="Choose the category of your recipe">
                        ...
                        <div class="form-floating mb-3 has-tooltip" title="Give a nice description to your recipe, so that people can have a better understanding of it">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-sm">
                                <div class="form-floating has-tooltip" title="How difficult to prepare is your recipe?">
                            ...
                            <div class="col-lg">
                                <div class="form-floating has-tooltip" title="How many servings does your recipe have? It needs to be at least 1">
                            ...
                            <div class="col-lg">
                                <div class="form-floating has-tooltip" title="Enter some subcategories so that people can find your recipe easily">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <button type="button" class="btn btn-secondary has-tooltip" id="addIngredientButton" title="Click here if you want to add another ingredient"><i class="fas fa-plus"></i> Add Ingredient</button>
                        <button type="button" class="btn btn-primary next-step" style="float: right;">Next</button>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-lg">
                        <div class="form-floating has-tooltip" title="How many minutes does it take to prepare your recipe?">
                    ...
                    <div class="col-lg">
                        <div class="form-floating has-tooltip" title="How many minutes does your recipe need to be in the oven?">
                    ...
                    <div class="col-lg">
                        <div class="form-floating has-tooltip" title="How many minutes does it take to make the final adjustments in the recipe preparation?">
                ...
                <button type="button" class="btn btn-secondary has-tooltip" id="addStepButton" title="Click here to add another step"><i class="fas fa-plus"></i> Add Step</button>
