...
CREATE MATERIALIZED VIEW recipes_fts_view AS
    SELECT tb_recipe.id AS recipe_id, tb_recipe.id_category as id_category, tb_recipe.name AS recipe_name, tb_member.id AS member_id, tb_member.name AS member_name,
